...
# AMAS 11-03-2026
Make a concat file with trimmed alignments. First of all we need to remove _R_ pattern from headers, it's very important to do at first because concat command nedds to have same headers. 
