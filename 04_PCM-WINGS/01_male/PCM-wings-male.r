...
setwd("/home/STUDENTI/pietro.bacconi/Tirocinio_magistrale/04_PCM-WINGS/01_male")
...
title(main="Wings Ancestral Trait Male ER", font.main = 1, adj = 1)
# for ARD plot 
title(main="Wings Ancestral Trait Male ARD", font.main = 1, adj = 1)
