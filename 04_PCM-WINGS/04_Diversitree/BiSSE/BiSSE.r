...
setwd("/home/STUDENTI/pietro.bacconi/Tirocinio_magistrale/04_PCM-WINGS/04_Diversitree/BiSSE")
tree.B  <- read.tree("aa_iln2_noHPD.tre")         # adjust if it's the same tree/subset
