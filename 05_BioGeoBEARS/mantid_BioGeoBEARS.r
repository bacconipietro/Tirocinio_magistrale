...
## load the tree
tree<-read.tree("aa_iln2_named_pruned.tre")
## read data from file
...
max_range_size<-5
bgb_run<-define_BioGeoBEARS_run(num_cores_to_use=12,max_range_size=max_range_size,trfn="./aa_iln2_named_pruned.tre", return_condlikes_table=TRUE)
...
## Save DEC.fit results
saveRDS(DEC.fit, file = "DEC_fit_result.rds")
