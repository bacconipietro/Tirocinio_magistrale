...
class Alignment:
    ...
    def get_name(self):
        # get input file name
        in_filename = path.basenf.in_file)
        return in_filename
...
class MetaAlignment():
    ...
    def get_concatenated(self, alignments):
        ...
        # you need his to insert empty seqs in
    ...
    def print_raxml_partitions(self, data_type, codons):
        ...
        if data_type == "dna":
            if codons == "none":
                ...
                for key in part_list:
                    start, end = str(part_dict[key]).split("-")
                    part_string += "DNA, " + key + "_pos1" + " = " + start + "-" + end + "\\3" + "      part_string += "DNA, " + key + "_pos2" + " = " + str(int(start) + 1) + "-" + end + "\\3" + "\n"
